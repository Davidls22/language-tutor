...
<div class="max-h-[60vh] overflow-y-auto p-4 border border-gray-300 rounded-lg bg-gray-50  p-4 space-y-4 relative">
  <div class="bg-yellow-50 text-yellow-800 p-2 rounded mb-5 text-sm border border-yellow-300">
  ...
  {#each messages as message (message.id)}
    {#if message.sender === 'tutor'}
      <div class="p-3 mt-3 mb-3 rounded-lg bg-orange-100 border border-orange-300 shadow-sm relative">
